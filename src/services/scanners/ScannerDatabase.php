...
class ScannerDatabase extends BaseScannerDatabase
{
    ...
    {
        $this->scanner->stdout('Extracting messages from ' . $tables['table'] . '.' . implode(',', $tables['columns']),
                               Console::FG_GREEN);
        ...
        foreach ($data as $columns) {
            ...
            foreach ($columns as $column) {
                ...
                if ($parsing === false) {
                    $this->scanner->stdout('An error occurred while checking for pattern' . PHP_EOL, Console::BOLD,
                                           Console::FG_RED);
                } else {
